...
100XP
    ...
    2   Perform a flat hierarchical clustering by using the fcluster() function on mergings.
    ...
    4   Create a cross-tabulation ct between df['labels'] and df['varieties'] to count the number of times each
        grain variety coincides with each cluster label.
