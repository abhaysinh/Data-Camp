...
samples, where each row represents a single 13x8 image. The images in your dataset are pictures of a LED digital display.
...
100XP
    ...
    2   Select row 0 of samples and assign the result to digit. For example, to select column 2 of an array a,
