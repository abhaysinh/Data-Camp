...
100XP
    ...
    3   Apply .fit_transform() method of tfidf to documents and assign the result to csr_mat.
    ...
    5   The columns of the array correspond to words. Get the list of words by calling the .get_feature_names()
        method of tfidf, and assign the result to words.
