...
to convert a value into a string. str(savings), for example, will convert the integer savings to a string.
...
100 XP
    ...
    1   Hit Run Code to run the code. Try to understand the error message.
