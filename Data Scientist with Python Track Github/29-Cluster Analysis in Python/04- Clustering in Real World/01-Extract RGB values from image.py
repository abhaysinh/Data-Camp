...
100 XP
    ...
    1   Import image class of matplotlib.

    2   Read the image using the imread() function and print the dimensions of the resultant matrix.

    3   Store the values for the three colors from all pixels in lists r, g and b.
