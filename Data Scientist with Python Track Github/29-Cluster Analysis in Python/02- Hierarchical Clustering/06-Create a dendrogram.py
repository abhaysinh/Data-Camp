...
100 XP
    ...
    1   Import the dendrogram function from scipy.cluster.hierarchy.

    2   Create a dendrogram using the linkage object.

    3   Display the dendrogram using .show() method of the plt object.
