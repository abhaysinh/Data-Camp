...
Instructions
    ...
    1   Import the random class from numpy and initialize the seed with the integer 0.  - 50 XP

    2   Change your code from the earlier step so that the seed is initialized with a list [1, 2, 1000].    - 50 XP
