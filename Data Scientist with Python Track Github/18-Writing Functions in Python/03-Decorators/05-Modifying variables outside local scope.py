...
Instructions
    ...
    1   Add a keyword that lets us update call_count from inside the function.  - 35 XP

    2   Add a keyword that lets us modify file_contents from inside save_contents().    - 35 XP

    3   Add a keyword to done in check_is_done() so that wait_until_done() eventually stops looping.    - 30 XP
