...
Instructions
    ...
    1   Start by completing the returns_dict() decorator so that it raises an AssertionError
        if the return type of the decorated function is not a dictionary.       - 50 XP

    2   Now complete the returns() decorator, which takes the expected return type as an argument.   - 50 XP
