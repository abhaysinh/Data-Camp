...
100xp
    ...
    1   Use np.cov() to compute the covariance matrix for the petal length
        (versicolor_petal_length) and width (versicolor_petal_width) of I. versicolor.

    2   Print the covariance matrix.

    3   Extract the covariance from entry [0,1] of the covariance matrix. Note that by symmetry,
