...
100xp
    ...
    1   Create percentiles, a NumPy array of percentiles you want to compute. These are the 2.5th,
    ...
    2   Use np.percentile() to compute the percentiles of the petal lengths from the Iris versicolor
