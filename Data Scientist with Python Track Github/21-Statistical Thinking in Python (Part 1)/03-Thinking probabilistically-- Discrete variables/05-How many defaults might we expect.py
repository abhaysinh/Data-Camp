...
100xp
    ...
    2   Initialize n_defaults, an empty array, using np.empty(). It should contain 1000 entries,
        since we are doing 1000 simulations.

    3   Write a for loop with 1000 iterations to compute the number of defaults per 100 loans using
    ...
    4   Plot a histogram of n_defaults. Include the normed=True keyword argument so that the height of
