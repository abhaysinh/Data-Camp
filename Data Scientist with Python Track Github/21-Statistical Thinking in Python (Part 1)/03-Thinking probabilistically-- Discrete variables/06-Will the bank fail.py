...
100xp
    ...
    2   Plot the ECDF, making sure to label the axes. Remember to include marker = '.' and
        linestyle = 'none' in addition to x and y in your call plt.plot().

    3   Show the plot.

    4   Compute the total number of entries in your n_defaults array that were greater than or
    ...
    5   The probability that the bank loses money is the fraction of n_defaults that are greater
