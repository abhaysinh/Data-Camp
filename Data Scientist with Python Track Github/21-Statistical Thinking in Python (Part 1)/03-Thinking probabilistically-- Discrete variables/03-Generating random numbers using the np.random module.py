...
100xp
    ...
    2   Initialize an empty array, random_numbers, of 100,000 entries to store the random numbers.
        Make sure you use np.empty(100000) to do this.
    3   Write a for loop to draw 100,000 random numbers using np.random.random(), storing them in
        the random_numbers array. To do so, loop over range(100000).
    4   Plot a histogram of random_numbers. It is not necessary to label the axes in this case
