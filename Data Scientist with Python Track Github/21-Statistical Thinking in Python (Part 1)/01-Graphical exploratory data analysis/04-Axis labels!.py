...
100xp
        ...
        1       Label the axes. Don't forget that you should always include units in your axis labels. Your
                y-axis label is just 'count'. Your x axis label is 'petal length (cm)'. The units are essential!
