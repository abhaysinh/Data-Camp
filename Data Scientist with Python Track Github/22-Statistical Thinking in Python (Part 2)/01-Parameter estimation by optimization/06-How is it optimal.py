...
INSTRUCTIONS
100XP
    1   Specify the values of the slope for which to compute the RSS. Use np.linspace() to get 200 points
    ...
    2   Initialize an array, rss, to contain the RSS using np.empty_like() and the array you created above.
        The empty_like() function returns a new array with the same shape and type as a given array (in this case, a_vals).

    3   Write a for loop to compute the sum of RSS of the slope. Hint: the RSS is given by
