...
100XP
    ...
    1   Compute the slope and intercept of the regression line using np.polyfit().
    ...
    3   To plot the best fit line, create an array x that consists of 0 and 100 using np.array().
