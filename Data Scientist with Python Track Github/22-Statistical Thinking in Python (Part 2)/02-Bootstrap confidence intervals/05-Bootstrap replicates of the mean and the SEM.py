...
100XP
    ...
    1   Draw 10000 bootstrap replicates of the mean annual rainfall using your draw_bs_reps() function and the
    ...
    2   Compute and print the standard error of the mean of rainfall.
        -The formula to compute this is np.std(data) / np.sqrt(len(data)).

    3   Compute and print the standard deviation of your bootstrap replicates bs_replicates.

    4   Make a histogram of the replicates using the normed=True keyword argument and 50 bins.
