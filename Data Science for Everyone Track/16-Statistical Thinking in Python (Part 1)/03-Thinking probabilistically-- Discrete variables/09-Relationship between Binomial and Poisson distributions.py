...
100xp
    ...
    2   Make a list of the n and p values to consider for the Binomial distribution. Choose n =
        [20, 100, 1000] and p = [0.5, 0.1, 0.01] so that np is always 10.

    3   Using np.random.binomial() inside the provided for loop, draw 10000 samples from a Binomial
