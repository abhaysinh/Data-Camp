...
100xp
    ...
    1   Compute the variance of the data in the versicolor_petal_length array using np.var().

    2   Print the square root of this value.
    3   Compute the standard deviation of the data in the versicolor_petal_length array using np.std() and print the result.
