...
Your job is to fit a linear regression and then predict the life expectancy, overlaying these predicted values on the
plot to generate a regression line. You will also compute and print the R^2 score using sckit-learn's .score() method.
...
100XP
    ...
    4   Fit the regressor to the data (X_fertility and y) and compute its predictions using the .predict() method and
        the prediction_space array.

    5   Compute and print the R^2 score using the .score() method.
